; GitHub CI 专用安装包脚本
; 与 OptiMemory.iss 的区别：
;   - 不依赖 ChineseSimplified.isl（GitHub runner 的 Inno Setup 只含英文语言包）
;   - 版本号通过命令行 /DMyAppVersion=x.y.z 注入，无需改动脚本本身
;
; 本地构建请使用 installer/OptiMemory.iss + build.ps1
